...
@section('content')
    ...
    <div class="d-flex justify content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Info Lowongan Baru</h1>
    </div>
    ...
    <div class="col-lg-8 mx-2">
        <form method="post" action="/dashboard" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('registration_time') is-invalid @enderror" id="registration_time" name="registration_time" required value="{{ old('registration_time') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('loc') is-invalid @enderror" id="loc" name="loc" required value="{{ old('loc') }}">
                @error('loc')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="company_type" name="company_type" value="{{ old('company_type') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="criteria" name="criteria" value="{{ old('criteria') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('apply') is-invalid @enderror" id="apply" name="apply" required value="{{ old('apply') }}">
                @error('apply')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('source') is-invalid @enderror" id="source" name="source" required value="{{ old('source') }}">
                @error('source')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cp" name="cp" value="{{ old('narahubung') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="employees" name="employees" value="{{ old('employees') }}">
            </div>
            <div class="mb-3">
